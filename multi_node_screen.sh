...
screen -S elixir-research -p PORT4001 -X stuff $'sleep 5; PORT=4001 PERSISTENCE_PATH=apps/aecore/priv/rox_db_4001 iex -S mix phx.server -e "Aecore.Peers.Worker.add_peer(\\""127.0.0.1:4000\\"")"\n'
screen -S elixir-research -p PORT4002 -X stuff $'sleep 10; PORT=4002 PERSISTENCE_PATH=apps/aecore/priv/rox_db_4002 iex -S mix phx.server -e "Aecore.Peers.Worker.add_peer(\\""127.0.0.1:4000\\"")"\n'
