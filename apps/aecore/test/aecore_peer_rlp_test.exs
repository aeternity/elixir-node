  ...
  def header_response_object do
    %{
      object: %Aecore.Chain.Header{
        height: 10,
        miner: <<131, 176, 158, 130, 105, 168, 173, 206, 60, 12, 9, 195, 175, 101,
    244, 247, 88, 195, 154, 242, 24, 251, 121, 61, 140, 221, 30, 163, 232, 118, 246, 220>>,
        nonce: 96,
        pow_evidence: [
          246,
          875,
    ...
    %{
      object: %Aecore.Chain.Block{
        header: %Aecore.Chain.Header{
          height: 10,
          miner: <<131, 176, 158, 130, 105, 168, 173, 206, 60, 12, 9, 195, 175, 101,
    244, 247, 88, 195, 154, 242, 24, 251, 121, 61, 140, 221, 30, 163, 232, 118,
    246, 220>>,
          nonce: 96,
          pow_evidence: [
            246,
