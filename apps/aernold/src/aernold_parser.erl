-module(aernold_parser).
-export([parse/1, parse_and_scan/1, format_error/1]).
-file("src/aernold_parser.yrl", 12).
...
-file("src/aernold_parser.erl", 178).
...
-file("src/aernold_parser.yrl", 13).
